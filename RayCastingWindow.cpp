...
void RayCastingWindow::render()
{
	...
	SDL_SetRenderDrawColor(_renderer.get(), 25, 199, 247, 255);
	SDL_RenderFillRect(_renderer.get(), &r_sky);
	SDL_SetRenderDrawColor(_renderer.get(), 13, 48, 8, 255);
	...
	SDL_SetRenderDrawColor(_renderer.get(), 12, 97, 4, 255);
	SDL_RenderFillRect(_renderer.get(), &r_player);
	SDL_SetRenderDrawColor(_renderer.get(), 115, 8, 99, 255);
